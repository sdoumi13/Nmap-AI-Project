...
export default function RobotPipeline({ 
  ...
  const robots = [
    ...
    },
    {
      id: 'RAG',
      name: 'RAG',
      description: 'Retrieval Augmented Generation | Contextual Knowledge Integration',
      icon: Cpu,
      color: 'purple',
      badge: 'LLM',
    ...
    },
    {
      ...
      description: 'Diffusion Models | Image Generation',
      icon: Code,
      color: 'purple',
      badge: 'LoRA',
    ...
    },
    {
      ...
      description: 'Validation | Self-Correction | Sandboxing | VM Execution',
      icon: Shield,
      color: 'emerald',
      badge: 'MCP',
